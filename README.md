...
The demo presents one complete Simple-symmetric geometry subcategory with the original 19-image preview and rating sequence, 10th-ranked familiar-image selection, and all 18 familiar-versus-novel preference trials. The demo does not request consent or demographics, create participant identifiers, use fullscreen mode, load questionnaires, or submit data to either backend.
